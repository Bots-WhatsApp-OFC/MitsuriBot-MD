...
𖥨ํ∘̥⃟⸽⃟💖➤ ${user.bannedReason ? `*𝐌𝐨𝐭𝐢𝐯𝐨/𝐬:* ${user.bannedReason}` : '*𝐌𝐨𝐭𝐢𝐯𝐨/𝐬:* 𝗦𝗶𝗻 𝗘𝘀𝗽𝗲𝗰𝗶𝗳𝗶𝗰𝗮𝗰𝗶𝗼𝗻𝗲𝘀'}
...
•╾•≫─•─⟡─•─°❬❅•❲💎❳•❅❭°─•─⟡─•─≪•╼•`.trim();
          ...
          if (botSpam.antispam && m.text && user && user.lastCommandTime && (Date.now() - user.lastCommandTime) < 30000 && !isROwner) {
            if (user.commandCount === 2) {
              ...
              if (remainingTime > 0) {
                const messageText = `> *💞 Por favor, espere: ${remainingTime}, para usar otro comando.*`;
                m.reply(messageText);
                return;
              } else {
                user.commandCount = 0;
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;🎀 𝙈𝙞𝙩𝙨𝙪𝙧𝙞𝘽𝙤𝙩-𝙈𝘿 🎀;;;\nFN:🎀 𝙈𝙞𝙩𝙨𝙪𝙧𝙞𝘽𝙤𝙩-𝙈𝘿 🎀\nORG:🎀 𝙈𝙞𝙩𝙨𝙪𝙧𝙞𝘽𝙤𝙩-𝙈𝘿 🎀\nTITLE:\nitem1.TEL;waid=5493873687620:+54 9 3873 68-7620\nitem1.X-ABLabel:🎀 𝙈𝙞𝙩𝙨𝙪𝙧𝙞𝘽𝙤𝙩-𝙈𝘿 🎀\nX-WA-BIZ-DESCRIPTION:Solo contactame si hay un problema con el bot.\nX-WA-BIZ-NAME:🎀 𝙈𝙞𝙩𝙨𝙪𝙧𝙞𝘽𝙤𝙩-𝙈𝘿 🎀\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, {contacts: {displayName: '🎀 𝙈𝙞𝙩𝙨𝙪𝙧𝙞𝘽𝙤𝙩-𝙈𝘿 🎀', contacts: [{vcard}]}}, {quoted: callmsg});
...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner: '*┏────◊───❲🌹❳───◊────┓*\n*║*    \`ADVERTENCIA / WARN\`\n*┗────◊───❲🌹❳───◊────┛*\n\n> *𖥨ํ∘̥⃟⸽⃟💖➣ _Este comando solo la creadora lo puede usar, y los SubCreadores asignados._*',
    owner: '*┏────◊───❲😗❳───◊────┓*\n*║*    \`ADVERTENCIA / WARN\`\n*┗────◊───❲😗❳───◊────┛*\n\n> *𖥨ํ∘̥⃟⸽⃟💖➣ _Este comando solo puede ser utilizado por el/la propietario(a) (owner) del Bot._*',
    mods: '*┏────◊───❲🍡❳───◊────┓*\n*║*    \`ADVERTENCIA / WARN\`\n*┗────◊───❲🍡❳───◊────┛*\n\n> *𖥨ํ∘̥⃟⸽⃟💖➣ _Este comando solo puede ser utilizado por moderadores y el/la propietario(a) (owner) del Bot._*',
    premium: '*┏────◊───❲🍓❳───◊────┓*\n*║*    \`ADVERTENCIA / WARN\`\n*┗────◊───❲🍓❳───◊────┛*\n\n> *𖥨ํ∘̥⃟⸽⃟💖➣ _Este comando solo puede ser utilizado por usarios premium y el/la propietario(a) (owner) del Bot._*',
    group: '*┏────◊───❲🍇❳───◊────┓*\n*║*    \`ADVERTENCIA / WARN\`\n*┗────◊───❲🍇❳───◊────┛*\n\n> *𖥨ํ∘̥⃟⸽⃟💖➣ _Este comando solo puede ser utilizado en grupos._*',
    private: '*┏────◊───❲🎆❳───◊────┓*\n*║*    \`ADVERTENCIA / WARN\`\n*┗────◊───❲🎆❳───◊────┛*\n\n> *𖥨ํ∘̥⃟⸽⃟💖➣ _Este comando solo puede ser utilizado en el chat privado del Bot._*',
    admin: '*┏────◊───❲🍨❳───◊────┓*\n*║*    \`ADVERTENCIA / WARN\`\n*┗────◊───❲🍨❳───◊────┛*\n\n> *𖥨ํ∘̥⃟⸽⃟💖➣ _Este comando solo puede ser usado por admins del grupo._*',
    botAdmin: '*┏────◊───❲🏙️❳───◊────┓*\n*║*    \`ADVERTENCIA / WARN\`\n*┗────◊───❲🏙️❳───◊────┛*\n\n> *𖥨ํ∘̥⃟⸽⃟💖➣ _Para poder usar este comando es necesario que yo sea admin._*',
    unreg: '*┏────◊───❲🌻❳───◊────┓*\n*║ ADVERTENCIA:*\n*No estas registrada/o*\n*┗────◊───❲🌻❳───◊────┛*\n\n> *𖥨ํ∘̥⃟⸽⃟💖➣Para usar este comando tienes que registrarte primero.*\n> *🌻➣ usar este comando: #verificar nombre.edad*\n\n> 🎀 *_Mitsuri-Bot-MD_* 🎀',
    restrict: '*┏────◊───❲🌆❳───◊────┓*\n*║*    \`ADVERTENCIA / WARN\`\n*┗────◊───❲🌆❳───◊────┛*\n\n> *𖥨ํ∘̥⃟⸽⃟💖➣ Este comando esta prohibido por la creadora.*',
  }[type];
  const aa = {quoted: m, userJid: conn.user.jid};
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '🎀 𝙈𝙞𝙩𝙨𝙪𝙧𝙞𝘽𝙤𝙩-𝙈𝘿 🎀', body: '🌻 𝘽𝙤𝙩 𝙙𝙚 𝙒𝙝𝙖𝙩𝙨𝘼𝙥𝙥 𝙥𝙖𝙧𝙖 𝙩𝙤𝙙𝙤𝙨 🌻', thumbnail: imagen1, sourceUrl: 'https://wa.me/5493873687620'}}}}, aa);
