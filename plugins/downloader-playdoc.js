...
> ◊═════════════════◊
> ╭•✧͢⃟ᤢ📡 \`𝗜𝗗 𝗗𝗘𝗟 𝗖𝗢𝗡𝗧𝗘𝗡𝗜𝗗𝗢\` ❩•
> ┋
> ╰◊➣ ${yt_play[0].videoId}
> ◊═════════════════◊
> ╭•✧͢⃟ᤢ🔑 \`𝗧𝗜𝗣𝗢 𝗗𝗘 𝗖𝗢𝗡𝗧𝗘𝗡𝗜𝗗𝗢\` ❩•
> ┋
> ╰◊➣ ${yt_play[0].type}
> ◊═════════════════◊
> ╭•✧͢⃟ᤢ🔄 \`𝗘𝗡𝗟𝗔𝗖𝗘\` ❩•
...
> ╰◊➣ ${yt_play[0].url}\n
> ◊═════════════════◊
\`𝙎𝙚 𝙚𝙨𝙩𝙖 𝙙𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙣𝙙𝙤 𝙨𝙪 𝙘𝙤𝙣𝙩𝙚𝙣𝙞𝙙𝙤, 𝙥𝙤𝙧 𝙛𝙖𝙫𝙤𝙧 𝙚𝙨𝙥𝙚𝙧𝙚 𝙪𝙣 𝙢𝙞𝙣𝙪𝙩𝙤, 𝙙𝙚𝙥𝙚𝙣𝙙𝙚 𝙙𝙚 𝙦𝙪𝙚 𝙩𝙖𝙣 𝙥𝙚𝙨𝙖𝙙𝙤 𝙨𝙚𝙖 𝙚𝙡 𝙘𝙤𝙣𝙩𝙚𝙣𝙞𝙙𝙤 𝙚𝙣𝙫𝙞𝙖𝙙𝙤.\``.trim();
