const handler = async (m, { conn, command, text, usedPrefix }) => {
  ...
  switch (command) {
    case 'gay2':
      ...
      if (percentages < 50) {
      if (percentages < 50) {
        description = `> *𖥨ํ∘̥⃟⸽⃟💦➤ Los calculos han arrojado que ${text.toUpperCase()} es ${percentages}% Gay. ${emoji}*\n> *-𖥨ํ∘̥⃟⸽⃟🍀➤ Eso es bajo... ¡Tu eres medio hetero, no Gay! 😳*`;
      } else if (percentages > 100) {
        description = `> *𖥨ํ∘̥⃟⸽⃟💦➤ Los calculos han arrojado que ${text.toUpperCase()} es ${percentages}% Gay. ${emoji}*\n> *-𖥨ํ∘̥⃟⸽⃟🍀➤ No no, asi no tenias que ser, eres mas gay de lo que la humanidad pensaba. 🔔*`;
      } else {
        description = `> *𖥨ํ∘̥⃟⸽⃟💦➤ Los calculos han arrojado que ${text.toUpperCase()} es ${percentages}% Gay. ${emoji}*\n> *-𖥨ํ∘̥⃟⸽⃟🍀➤ No temas, no sabemos por que eres gay, pero dios lo quiso por que si 🌻*`;
      }
      break;
    case 'lesbiana':
      emoji = '🏳️‍🌈';
      if (percentages < 50) {
        ...
        description = `> *𖥨ํ∘̥⃟⸽⃟💦➤ Los cálculos han arrojado que ${text.toUpperCase()} es ${percentages}% ${command}. ${emoji}*\n> *-𖥨ํ∘̥⃟⸽⃟🍀➤ ¡Eso es un amor extremo por las chicas! 🚺 🚺*`;
      } else {
  ...
  const responses = [
    "Que raro, casi siempre es al revés ._.",
    "Tenemos a un/a prepago/a cualquiera",
    "Ke karajo ._."
  ];
