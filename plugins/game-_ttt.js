...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} 😄 𝙂𝙖𝙣𝙖𝙨𝙩𝙚: +1209 𝙙𝙚 𝙚𝙭𝙥𝙚𝙧𝙞𝙚𝙣𝙘𝙞𝙖!!!` : isTie ? '❮🤨❯ ¡𝙀𝙡 𝙟𝙪𝙚𝙜𝙤 𝙩𝙚𝙧𝙢𝙞𝙣𝙤, 𝙖𝙢𝙗𝙤𝙨 𝙦𝙪𝙚𝙙𝙖𝙣 𝙚𝙣 𝙚𝙢𝙥𝙖𝙩𝙚!' : `❮😍❯ 𝘼𝙝𝙤𝙧𝙖 𝙚𝙨 𝙩𝙪𝙧𝙣𝙤 𝙙𝙚: @${room.game.currentTurn.split('@')[0]}`}
`.trim();
