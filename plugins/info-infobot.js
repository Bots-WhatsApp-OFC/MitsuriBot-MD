...
╰•⚜️•┈┈┈••┈┈••✦🛡️✦••┈┈••┈┈┈•⚜️•╯`.trim();
  ...
  const Message = {
    document: { url: `https://wa.me/5493873687620` },
    mimetype: `application/${document}`,
    fileName: `🌸 𝙈𝙞𝙩𝙨𝙪𝙧𝙞 𝘽𝙤𝙩 𝙈𝘿 🌸`,
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://github.com/Bots-WhatsApp-OFC/MitsuriBot-MD",
        mediaType: 2,
        previewType: "pdf",
        title: "𝘽𝙤𝙩 𝙙𝙚 𝙒𝙝𝙖𝙩𝙨𝘼𝙥𝙥",
        body: wm,
        thumbnail: imagen6,
